...
export const achievements: Achievement[] = [
  ...
  },
  {
    ...
    subItems: [
      { id: 'chocobo', label: 'Chocobo' },
      { id: 'shiva', label: 'Shiva' },
      { id: 'ifrit', label: 'Ifrit' },
      { id: 'dragon', label: 'Dragon' },
      { id: 'titan', label: 'Titan' },
      { id: 'ramuh', label: 'Ramuh' },
      { id: 'odin', label: 'Odin' },
      { id: 'asura', label: 'Asura' },
      { id: 'leviathan', label: 'Leviathan' },
      { id: 'sylph', label: 'Sylph' },
      { id: 'bahamut', label: 'Bahamut' },
    ],
  },
  {
    id: 'developers-pal',
  ...
  },
  {
    ...
    subItems: [
      { id: 'sighting-01', label: '1. Baron Castle, west tower' },
      { id: 'sighting-02', label: '2. Mist Cave' },
      { id: 'sighting-03', label: "3. Kaipo, Rosa's room" },
      ...
      { id: 'sighting-11', label: "11. Mysidia, Elder's house" },
      { id: 'sighting-12', label: '12. Moon, near the Hummingway Abode' },
      { id: 'sighting-13', label: '13. Final sighting (several possible locations)' },
    ],
  },
  {
  ...
  },
  {
    ...
    subItems: [
      { id: 'bomb', label: 'Bomb (rare drop: Balloon, Dark Grenade)' },
      { id: 'cockatrice', label: 'Cockatrice (rare drop: Helldiver, Fledgling Rukh)' },
      { id: 'goblin', label: "Goblin (rare drop: Goblin, Li'l Murderer)" },
      { id: 'mindflayer', label: 'Mindflayer (rare drop: Mindflayer)' },
    ],
  },
  {
    id: 'defeated-geryon',
